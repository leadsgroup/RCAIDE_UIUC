...
def compute_ice_performance(propulsor,state,fuel_line=None,bus=None,center_of_gravity= [[0.0, 0.0,0.0]]):  
    ...
    moment         = conditions.energy[propulsor.tag][propeller.tag].moment 
...
def reuse_stored_ice_data(propulsor,state,network,fuel_line,bus,stored_propulsor_tag,center_of_gravity= [[0.0, 0.0,0.0]]):
