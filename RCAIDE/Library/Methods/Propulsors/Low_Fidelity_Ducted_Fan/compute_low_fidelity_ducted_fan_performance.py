...
def compute_low_fidelity_ducted_fan_performance(low_fidelity_ducted_fan,state,center_of_gravity= [[0.0, 0.0,0.0]]):  
    ...
    fan_conditions.inputs.gas_specific_constant                       = conditions.freestream.gas_specific_constant
    ...
    low_fidelity_ducted_fan_conditions.fan_exit_velocity                        = fan_conditions.outputs.velocity
