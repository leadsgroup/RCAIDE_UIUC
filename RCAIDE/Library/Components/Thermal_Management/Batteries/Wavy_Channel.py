...
# RCAIDE/Library/Components/Thermal_Management/Batteries/Heat_Acquisition_Systems/Conjugate_Heat_Aquisition.py
# 
# 
...
class Wavy_Channel(Component):
    ...
    def __defaults__(self):  
        ...
        Assumptions:
           The wavy channel heat acquistion loops through the battery pack.
