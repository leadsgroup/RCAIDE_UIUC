...
def write_wing_conformal_fuel_tank(vehicle, wing, wing_id, fuel_tank, fuel_tank_set_ind):
    ...
    * Required fuel tank parameters are defined
    ...
    if n_segments>0:
        span_trim_max = get_vsp_trim_from_RCAIDE_trim(seg_span_percents,  vsp_segment_breaks,  span_trim_max)
        span_trim_min = get_vsp_trim_from_RCAIDE_trim(seg_span_percents,  vsp_segment_breaks,   span_trim_min)
    else:
