    ...
    def evaluate(network,state,center_of_gravity):
        ...
        for bus in busses:
            ...
            if conditions.energy.recharging:
                ...
                electric_power = bus_conditions.power_draw 
        ...
        target_power = (1-state.conditions.energy.hybrid_power_split_ratio)*electric_power
        ...
        for fuel_line in fuel_lines:
            ...
            while np.any(np.abs(diff_target_power) > 1E-6):
                ...
                fuel_network_total_thrust = 0. * state.ones_row(3)
                fuel_network_total_moment = 0. * state.ones_row(3) 
                ...
                for propulsor_group in fuel_line.assigned_propulsors:
                    for propulsor_tag in propulsor_group:
                        ...
                        if propulsor.active and fuel_line.active: 
                            state.conditions.energy[propulsor.tag].throttle = throttle
                            if network.identical_propulsors == False:
                                # run analysis  
                            ...
                            fuel_network_total_thrust += T   
                            fuel_network_total_moment += M   
