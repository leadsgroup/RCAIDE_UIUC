...
def main(): 
    ...
    cruise_CL_2_truth        = 0.2384625151395397
    cruise_CL_3_truth        = 0.4492800029242009
    descent_throttle_1_truth = 0.11627556491686011
    curved_cruise_CL_truth   = 1.2797113716510762
    descent_throttle_2_truth = 0.5
    single_pt_CL_1_truth     = 0.0005711272577742668
    single_pt_CL_2_truth     = 0.0006616284937706554
