   ...
   .. raw:: html
      ...
      <div class="tutorial-container" style="padding: 25px; background: linear-gradient(145deg, #1a1f36, #2d3555); color: white; border-radius: 12px; transition: transform 0.2s; max-width: 100%; overflow-x: auto;">
        ...
        <div class="tutorial-links" style="margin-top: 15px; display: flex; flex-direction: column; gap: 10px;">
          ...
          <a href="Optimization/Tutorial_21_payload_range_diagram.html" class="tutorial-link" style="color:white; text-decoration:none; font-size:1.1em; padding: 8px 16px; border: 1px solid white; border-radius:8px; transition: background 0.2s;">
...
.. toctree::
   ...
   Optimization/Tutorial_21_payload_range_diagram